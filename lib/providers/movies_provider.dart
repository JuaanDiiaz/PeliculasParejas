...
class MoviesProvider extends ChangeNotifier {
  ...
  getMovieCategories() async {
    ...
    final response = await http.get(url);
    print(response.body);
    final genresResponse = GenresResponse.fromRawJson(response.body);
  ...
  getMoviesByGenre(
    ...
    if (genreMovies.containsKey(genreId)) return genreMovies[genreId]!;
    ...
    final response = await http.get(url);
    final moviesResponse = SearchResponse.fromJson(response.body);
    genreMovies[genreId] = [...moviesResponse.results];
    notifyListeners();
  }
